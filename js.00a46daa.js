...
},{"buffer":"../node_modules/buffer/index.js"}],"../node_modules/sweetalert/dist/sweetalert.min.js":[function(require,module,exports) {
var define;
...
},{}],"assets/simonSound1.mp3":[function(require,module,exports) {
module.exports = "/simonJS/simonSound1.9bec4ddb.mp3";
},{}],"assets/simonSound2.mp3":[function(require,module,exports) {
module.exports = "/simonJS/simonSound2.0ec1a7dd.mp3";
},{}],"assets/simonSound3.mp3":[function(require,module,exports) {
module.exports = "/simonJS/simonSound3.ae729e0e.mp3";
},{}],"assets/simonSound4.mp3":[function(require,module,exports) {
module.exports = "/simonJS/simonSound4.a5ee209b.mp3";
...
var audioUrl1 = require("../assets/simonSound1.mp3");

var audioUrl2 = require("../assets/simonSound2.mp3");

var audioUrl3 = require("../assets/simonSound3.mp3");

var audioUrl4 = require("../assets/simonSound4.mp3");

var audioQ = new _howler.Howl({
  src: [audioUrl1]
});
var audioW = new _howler.Howl({
  src: [audioUrl2]
});
var audioE = new _howler.Howl({
  src: [audioUrl3]
});
var audioR = new _howler.Howl({
  src: [audioUrl4]
}); // eslint-disable-next-line quotes

var button = document.querySelector(".buttonStart");
var letterQ = document.querySelector(".q");
var letterW = document.querySelector(".w");
var letterE = document.querySelector(".e");
var letterR = document.querySelector(".r");
var difEasy = document.querySelector(".easy");
var difMedium = document.querySelector(".medium");
var difHard = document.querySelector(".hard");
...
var animateSingleLetter = function animateSingleLetter(letter) {
  switch (letter) {
    case "Q":
...
var getRandomLetter = function getRandomLetter() {
  ...
  var iterations = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
  isRunning = true;
  ...
  (function loop(i) {
    setTimeout(function () {
      var randomLetter = _lodash.default.sampleSize(arrayLetters);
...
var setScores = function setScores(score) {
...
var checkAnswer = function checkAnswer(size) {
  try {
    if (arrayAnswers[size - 1] === arrayRandomLetters[size - 1].toString()) {
      correctAnswers += 1;
      correctValue.textContent = "Correct answers: ".concat(correctAnswers);
      ...
      setTimeout(function () {
        ...
        (0, _sweetalert.default)("Oops!", "You lost! 😔", "error").then(function (doClose) {
          if (doClose) {
...
var showRules = function showRules() {
  if (localStorage.rules === undefined) {
    ...
    (0, _sweetalert.default)("Rules!", "Rules are simple. Players must repeat random sequences of sounds by pressing the colored keys in the correct order. ", "info");
  }
};

showRules();
},{"howler":"../node_modules/howler/dist/howler.js","lodash":"../node_modules/lodash/lodash.js","sweetalert":"../node_modules/sweetalert/dist/sweetalert.min.js","../assets/simonSound1.mp3":"assets/simonSound1.mp3","../assets/simonSound2.mp3":"assets/simonSound2.mp3","../assets/simonSound3.mp3":"assets/simonSound3.mp3","../assets/simonSound4.mp3":"assets/simonSound4.mp3"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/simonJS/js.00a46daa.js.map